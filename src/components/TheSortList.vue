<template>
  <div class="sort-wrapper">
    <div class="sort__buttons">
      <button onclick="tracks = insertionsort(tracks)">Insertionsort</button>
      <button>Bubblesort</button>
      <button>Mergesort</button>
    </div>
    <div class="sort__items">
      <SortItem v-for="track in tracks" :id="track.id" :artists="track.artists" :name="track.name">
      </SortItem>
    </div>
  </div>
</template>
...
import { ref } from "vue";
import { insertionsort } from "@/services/sort";
...
const tracks = ref([
  ...
  { "id": "4erCNyobZsqLhUwNiN4nkF", "artists": "Blond", "name": "Outro" },
  {
    ...
    "artists": "Blond, Drangsal, Leoniden, Cashmiri, Zugezogen Maskulin, FIBEL, Shelter Boy, The toten Crackhuren im Kofferraum (The TCHIK), Von Wegen Lisbeth, Mia Morgan, KUMMER, Swutscher, CHILDREN, Fatoni, Steiner, Madlaina, Rikas, Lance Butters",
  ...
  { "id": "10AnIv6fUvybolzbPAxmiA", "artists": "Blond", "name": "Du und Ich" },
  {
    ...
    "artists": "The toten Crackhuren im Kofferraum (The TCHIK), Taby Pilgrim, Blond",
